...
- Linux でウィンドウを最大化したときにターミナルインターフェイスのレンダリングがタイムリーに更新されない問題を修正
...
- MacOS のネイティブ UI スタイルでタイトルボタンのフルスクリーンが、インターフェイス上のコンテキストメニューでフルスクリーンを終了するオプションを表示できない問題を修正
...
- グローバル設定インターフェイスを更新し、カテゴリごとに設定を表示します
- セッション設定インターフェイスを追加し、セッションプロパティを変更および編集できるようになりました
...
- tfftp サーバーを開始する実用的な機能を追加
- HEX ビュー表示インターフェイスを最適化
...
- メインインターフェイスにメニューバーとツールバーを追加し、より多くの右クリックメニューを改善
- ターミナルインターフェイスのカラースタイルを追加
- 動的な言語切り替え機能を追加
- 動的なテーマ切り替え機能を追加

## [[V0.0.1](https://github.com/QQxiaoming/quardCRT/releases/tag/V0.0.1)] - 2023-09-26

- メインインターフェイスのターミナル機能を実現
- ラベルタブのページング管理を追加
- Telnet プロトコルをサポート
- シリアルポートプロトコルをサポート
- RAW プロトコルをサポート
- ローカルシェルをサポート
- インターフェイスは簡体字中国語/英語/日本語をサポート
